...
#SBATCH -o $output_dir/slurm_output/slurm.bowtie2_sort_dedup_MergeBam.JOBNAME.%N.%j.out # STDOUT
#SBATCH -e $output_dir/slurm_output/slurm.bowtie2_sort_dedup_MergeBam.JOBNAME.%N.%j.err # STDERR
#SBATCH -J bowtie2_sort_dedup_MergeBam.JOBNAME
#SBATCH --mail-type=END,FAIL # notifications for job done & fail
#SBATCH --mail-user=philippa.borrill\@jic.ac.uk # send-to address
SLURM


 my $tmp_file = "$output_dir/tmp/bowtie2_lsf_06_04_2016.$dir";
...
#source and run bowtie2 with paired ends, max insert size 500, 8 threads
 ...
 #   print SLURM "bowtie2 -p 8 -X 500 -x $ref -1 $pair_1_R1 -2 $pair_1_R2 -S $output_dir/$output"."_n$mismatches.sam\n";
