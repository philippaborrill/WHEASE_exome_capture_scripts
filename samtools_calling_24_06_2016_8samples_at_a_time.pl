...
print SLURM "/usr/users/metbio/borrillp/bin/bcftools view $output_dir/high_depth_removed/samtools.$set_of_samples"."_MAPQ7.raw.bcf | /usr/users/metbio/borrillp/bin/vcfutils.pl varFilter > samtools.$set_of_samples"."_MAPQ7.flt.vcf \n";
