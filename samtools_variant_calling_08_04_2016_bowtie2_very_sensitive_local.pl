...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/samtools_variant_calling_slurm_08_04_2016.$output";
...
print SLURM "srun /usr/users/metbio/borrillp/bin/samtools mpileup -D -A -Q 20 -q 20 -u -g -f $ref $output_dir/$sample".".MergeBam_merged_markdup_rm_2nd_time.bam | /usr/users/metbio/borrillp/bin/bcftools view -bvcg - > $output_dir/$sample".".MergeBam_merged_markdup_rm_2nd_time_var.raw.bcf \n";

# options for vcfutils.pl varFilter
# -D 1000 max read depth
# -a min alt base reads

print SLURM "/usr/users/metbio/borrillp/bin/bcftools view $output_dir/$sample".".MergeBam_merged_markdup_rm_2nd_time_var.raw.bcf | /usr/users/metbio/borrillp/bin/vcfutils.pl varFilter -a 3 -D 1000 > $output_dir/$sample".".MergeBam_merged_markdup_rm_2nd_time_var.flt.vcf \n";
