...
#combine the data 
print SLURM "srun gatk -T CombineVariants -R $ref -V:VCF $path/exome_capture_analysis/inter-homoeologous_variants_ensembl_replaced_ambig_var.sorted.vcf -V:$sample $sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time_var.flt.vcf -o inter_homoeologue_with_$sample"."_merged.vcf \n";
