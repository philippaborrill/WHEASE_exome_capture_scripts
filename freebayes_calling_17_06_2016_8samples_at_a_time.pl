...
#SBATCH -o $output_dir/slurm_output/sets_of_freebayes_variant_calling_slurm_.JOBNAME.%N.%j.out # STDOUT
#SBATCH -e $output_dir/slurm_output/sets_of_freebayes_variant_calling_slurm_.JOBNAME.%N.%j.err # STDERR
...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/freebayes_variant_calling_slurm_17_06_2016.$set_of_samples";
