...
LSF
 ...
 my $tmp_file = "$output_dir/tmp/picard_lsf.$sample";
  ...
  print BSUB "samtools merge $sample"."_n$mismatches.sorted.bam $sample"."_1_n$mismatches.sorted.bam $sample"."_2_n$mismatches.sorted.bam\n";
  print BSUB "samtools flagstat $sample"."_n$mismatches.sorted.bam > $sample"."_n$mismatches.sorted.flagstat.txt\n";
