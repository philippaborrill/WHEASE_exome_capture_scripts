...
#SBATCH -o $output_dir/slurm_output/samtools_index.JOBNAME.%N.%j.out # STDOUT
#SBATCH -e $output_dir/slurm_output/samtools_index.JOBNAME.%N.%j.err # STDERR
...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/samtools_index_30_3_2016.$output";
...
print SLURM "srun samtools index $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.bam $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.bai \n";
