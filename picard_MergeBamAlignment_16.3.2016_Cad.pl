...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/picard_MergeBamAlignment_slurm_13-3-2016.$output";
...
#  print SLURM "picard CleanSam INPUT=$output_dir/no_bam_header/$output"."_n5.sorted.bam OUTPUT=$output_dir/no_bam_header/$output"."_n5.sorted.cleaned.bam\n";
