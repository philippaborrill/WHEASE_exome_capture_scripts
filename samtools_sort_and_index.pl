...
#SBATCH -o $output_dir/slurm_output/slurm.samtools_index.JOBNAME.%N.%j.out # STDOUT
#SBATCH -e $output_dir/slurm_output/slurm.samtools_index.JOBNAME.%N.%j.err # STDERR
#SBATCH -J samtools_index_JOBNAME
#SBATCH --mail-type=END,FAIL # notifications for job done & fail
#SBATCH --mail-user=philippa.borrill\@jic.ac.uk # send-to address
SLURM


 my $tmp_file = "$output_dir/tmp/samtools_index_slurm_30_3_2016.$output";
...
print SLURM "srun samtools index $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time.bam $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time.bai \n";
