...
#SBATCH -o $output_dir/slurm_output/freebayes_variant_calling_slurm_.JOBNAME.%N.%j.out # STDOUT
#SBATCH -e $output_dir/slurm_output/freebayes_variant_calling_slurm_.JOBNAME.%N.%j.err # STDERR
#SBATCH -J JOBNAME_freebayes_variant_calling_slurm
#SBATCH --mail-type=END,FAIL # notifications for job done & fail
#SBATCH --mail-user=philippa.borrill\@jic.ac.uk # send-to address
SLURM


 my $tmp_file = "$output_dir/tmp/freebayes_variant_calling_slurm_29_06_2016.$output";
...
print SLURM "srun freebayes -f $ref --use-best-n-alleles 2 --min-mapping-quality 7 --min-base-quality 20 --report-monomorphic $output_dir/$sample".".MergeBam_merged_markdup_rm_2nd_time.bam  > $output_dir/freebayes_$sample".".vcf \n";
...
print SLURM "srun freebayes -f $ref --use-best-n-alleles 2 --min-mapping-quality 7 --min-base-quality 20 --report-monomorphic $output_dir/$sample"."_MergeBamAlignment.bam  > $output_dir/freebayes_$sample".".vcf \n";
