...
SLURM
 ...
 my $tmp_file = "$output_dir/tmp/samtools_variant_calling_bwa_aln_20_04_2016.$output";
...
print SLURM "srun /usr/users/metbio/borrillp/bin/samtools mpileup -D -A -Q 20 -q 7 -u -g -f $ref $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time.bam | /usr/users/metbio/borrillp/bin/bcftools view -bvcg - > $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time_var_MAPQ7.raw.bcf \n";

# options for vcfutils.pl varFilter
# -D 1000 max read depth
# -a min alt base reads

print SLURM "/usr/users/metbio/borrillp/bin/bcftools view $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time_var_MAPQ7.raw.bcf | /usr/users/metbio/borrillp/bin/vcfutils.pl varFilter -a 3 -D 1000 > $output_dir/with_bam_header/$sample".".MergeBam.cleaned.markdup_rm.merged_markdup_rm_2nd_time_var_MAPQ7.flt.vcf \n";
