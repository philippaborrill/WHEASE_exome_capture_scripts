...
#SBATCH -o $output_dir/bwa-aln/slurm_output/slurm.FastqtoSam.JOBNAME.%N.%j.out # STDOUT
#SBATCH -e $output_dir/bwa-aln/slurm_output/slurm.FastqtoSam.JOBNAME.%N.%j.err # STDERR
...
SLURM
 ...
 my $tmp_file = "$output_dir/bwa-aln/tmp/picard_FastqtoSam_lsf_23-3-2016.$dir";
