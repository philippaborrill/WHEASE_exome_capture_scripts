...
print SLURM "srun gatk -T CombineVariants -R $ref -V:VCF $path/exome_capture_analysis/bwa-aln/with_bam_header/variants_found_in_2_or_more_Cadenza_het_in_at_least_1_mutant.vcf -V:$sample $sample".".MergeBam_merged_markdup_rm_2nd_time_var.flt.vcf -o hetCad_with_$sample"."_merged.vcf \n";

print SLURM "srun grep 'set=$sample' hetCad_with_$sample"."_merged.vcf > unique_to_$sample.vcf\n";
