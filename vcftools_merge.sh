#!/bin/bash
#
# SLURM batch script to launch vcftools merge
#
...
vcf-merge samtools.set1_MAPQ7.flt.vcf.gz samtools.set2_MAPQ7.flt.vcf.gz samtools.set3_MAPQ7.flt.vcf.gz  samtools.set4_MAPQ7.flt.vcf.gz samtools.set5_MAPQ7.flt.vcf.gz samtools.set6_MAPQ7.flt.vcf.gz samtools.set7_MAPQ7.flt.vcf.gz samtools.set8_MAPQ7.flt.vcf.gz > samtools_sets1-8_merged_by_vcf-tools.vcf

/nbi/software/testing/tabix/0.2.6/src/tabix-0.2.6/bgzip -c samtools_sets1-8_merged_by_vcf-tools.vcf > samtools_sets1-8_merged_by_vcf-tools.vcf.gz
/nbi/software/testing/tabix/0.2.6/src/tabix-0.2.6/tabix -p vcf samtools_sets1-8_merged_by_vcf-tools.vcf.gz
