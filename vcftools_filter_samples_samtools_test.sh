...
cd /nbi/Research-Groups/NBI/Cristobal-Uauy/WHEASE/exome_capture_analysis/bowtie2_very_sens_replaced_ambig/high_depth_removed
...
vcftools --vcf samtools_sets1-8_merged.vcf --out samtools_sets1-8_merged_filtered_0.75_REAL_indiv_cov --max-missing 0.75  --recode --recode-INFO-all
